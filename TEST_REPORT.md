...
entry as an exact flight target.
...
Result: `fractal_flight_studio-0.8.0-py3-none-any.whl` built locally. Inspection
of the wheel confirmed the packaged resource:

```text
fractal_flight_studio/data/deep_zoom_targets.json
```
...
- the later visual target-browser, timeline and offline-video workflow, which
